...
func _ready():
	Party.append(Chara)
	Chara = {"ID":1, "Name":"mons1", "LV" : 1, "currentXP": 0,"currentHP": 100,"maxHP": 100 ,  "speed": 0, "skills":[0,1,2,3],"isAlive":true, "Icon":load("res://icon.svg")}
	Party.append(Chara)
	Chara = {"ID":1, "Name":"mons2", "LV" : 1, "currentXP": 0,"currentHP": 100,"maxHP": 100 ,  "speed": 0, "skills":[0,1,2,3],"isAlive":true, "Icon":load("res://icon.svg")}
	Party.append(Chara)
